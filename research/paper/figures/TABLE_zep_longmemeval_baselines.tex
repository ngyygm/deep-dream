\begin{table}[t]
\centering
\caption{LongMemEval main results. Published rows (GPT-4o-mini / GPT-4o, Full-context vs.\ Zep) reproduced verbatim from \citet{rasmussen2025zep} (arXiv:2501.13956). The \textbf{Deep-Dream} row uses Qwen3.7-plus as both answerer and cross-judge---a different test procedure; its accuracy (84.6\%) is shown beside the published numbers with that condition stated. Latency and average context for Deep-Dream were not measured under the published test procedure (---). The six-category breakdown is in Table~\ref{tab:zep-longmemeval-cat}.}
