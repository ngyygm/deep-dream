...
class EntityProcessor:
    ...
    # ── Large method: _process_entity_with_batch_candidates ──
    # Kept on the class because it deeply references many self methods.
    # Could be extracted to entity_parallel in a future pass.
