...
r.entity1_family_id AS entity1_family_id,
r.entity2_family_id AS entity2_family_id,
...
def _neo4j_record_to_relation(record, _now: Optional[datetime] = None) -> Relation:
    ...
    return Relation(
        ...
        entity1_family_id=record.get("entity1_family_id", ""),
        entity2_family_id=record.get("entity2_family_id", ""),
        content=record.get("content", ""),
        event_time=_pd(record.get("event_time")) or _now,
        processed_time=_pd(record.get("processed_time")) or _now,
        episode_id=record.get("episode_id", ""),
